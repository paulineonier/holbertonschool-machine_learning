#!/usr/bin/env python3
"""
This module plots the exponential decay of C-14 with a logarithmic scale for the y-axis.
...
def change_scale():
    ...
    The x-axis represents time in years and the y-axis represents the fraction remaining.
    """
    ...
    plt.plot(x, y, 'b-')  # Plotting the data as a blue solid line
