...
def poly_derivative(poly):
    """
    Calcule la dérivée d'un polynôme représenté par une liste de coefficients.
    ...
    Returns:
        ...
        None: Si poly = pas une liste valide (par exemple, vide ou non-liste).
    ...
    Notes:
        - Si poly est vide ou ne contient que des constantes (par exemple [5]),
          la dérivée est [0].
    """
